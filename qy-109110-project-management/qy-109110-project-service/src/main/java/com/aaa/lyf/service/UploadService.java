...
import com.aaa.lyf.properties.FtpProperties;
import com.aaa.lyf.utils.FileNameUtils;
import com.aaa.lyf.utils.FtpUtils;
...
import static com.aaa.lyf.staticproperties.RedisProperties.POINT;
import static com.aaa.lyf.staticproperties.TimeForatProperties.DATA_FORMAT;
...
public class UploadService {
    ...
    **/
    public Boolean upload(MultipartFile file) {
        ...
        String filePath = DateUtil.formatDate(new Date(), DATA_FORMAT);
        // 5.调用文件上传工具类
        try {
